...
class MainPage(DefaultPage):
    ...
    def add_widgets(self):
        ...
        self.new_user_button = GrayButton(self.panel, "New user? Sign up here", self.sign_up_form, borderwidth=2,
                                          relief=RIDGE)
    ...
    def sign_up_form(self):
        ...
        Message(f, width=300, font=("Monotype Corsiva", 20, "bold", "italic"), text="FoodzApp Services", bg="white",
                relief=SOLID, borderwidth=2).grid(row=0, column=0, columnspan=3, pady=5)
        Message(f, text="Register with us to get the best of food experience", width=600, font="Roman 20 bold italic",
